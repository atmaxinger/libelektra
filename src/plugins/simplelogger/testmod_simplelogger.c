 ...
 * @file
 *
 * @brief Tests for simplelogger plugin
 *
...
static void test_basics (void)
{
	...
	Key * parentKey = keyNew ("user:/tests/simplelogger", KEY_END);
	KeySet * conf = ksNew (0, KS_END);
	PLUGIN_OPEN ("simplelogger");
...
int main (int argc, char ** argv)
{
	...
	print_result ("testmod_simplelogger");
