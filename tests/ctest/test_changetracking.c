...
static void test_shouldBeEnabled (void)
{
	printf ("running %s\n", __func__);
	...
	// Act
	bool isEnabled = elektraChangeTrackingIsEnabled (kdb);

	// Assert
	succeed_if (isEnabled == true, "change tracking should be enabled");
...
static void test_contextShouldNotBeNull (void)
{
	...
	// Act
	ChangeTrackingContext * context = elektraChangeTrackingGetContext(kdb, parentKey);
...
static void test_shouldFindAddedKeys (void)
{
	...
	const KeySet * addedKeys = elektraChangeTrackingGetAddedKeys (context);
	const KeySet * removedKeys = elektraChangeTrackingGetRemovedKeys (context);
	const KeySet * modifiedKeys = elektraChangeTrackingGetModifiedKeys (context);
